...
gtdb-sbdi-sativa.r207.1genome.assignTaxonomy.fna.gz: $(wildcard *.hmmer.rfmask.sativafilt1pt.fna.gz)
	$(ASSIGN_TAXONOMY)

gtdb-sbdi-sativa.r207.5genomes.assignTaxonomy.fna.gz: $(wildcard *.hmmer.rfmask.sativafilt5pt.fna.gz)
	$(ASSIGN_TAXONOMY)

gtdb-sbdi-sativa.r207.20genomes.assignTaxonomy.fna.gz: $(wildcard *.hmmer.rfmask.sativafilt20pt.fna.gz)
	$(ASSIGN_TAXONOMY)

gtdb-sbdi-sativa.r207.1genome.addSpecies.fna.gz: $(wildcard *.hmmer.rfmask.sativafilt1pt.fna.gz)
	$(ADD_SPECIES)

gtdb-sbdi-sativa.r207.5genomes.addSpecies.fna.gz: $(wildcard *.hmmer.rfmask.sativafilt5pt.fna.gz)
	$(ADD_SPECIES)

gtdb-sbdi-sativa.r207.20genomes.addSpecies.fna.gz: $(wildcard *.hmmer.rfmask.sativafilt20pt.fna.gz)
	$(ADD_SPECIES)
